...
export const Route = createFileRoute("/collections/best-shounen-anime")({
  component: BestShounenAnime,
  head: () => {
    const baseUrl = "https://animeorbit.com";
    return {
      meta: [
        { title: "Best Shounen Anime of All Time | AnimeOrbit" },
        { name: "description", content: "Discover the greatest shounen anime ever made. From classics like Naruto and One Piece to modern hits like Jujutsu Kaisen and Demon Slayer." },
        { name: "keywords", content: "best shounen anime, top shounen, must watch shounen, shounen recommendations" },
        { tagName: "link", rel: "canonical", href: `${baseUrl}/collections/best-shounen-anime` },
        { property: "og:title", content: "Best Shounen Anime of All Time | AnimeOrbit" },
        { property: "og:description", content: "The ultimate list of best shounen anime. Action, friendship, and epic battles." },
        { property: "og:url", content: `${baseUrl}/collections/best-shounen-anime` },
...
function BestShounenAnime() {
  const collectionAnime = useQuery({
    queryKey: ["collection", "best-shounen-anime"],
    ...
    <div className="min-h-screen bg-[#071120]">
      ...
      <main className="mx-auto max-w-7xl px-4 pb-20 pt-10 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="Epic battles, powerful friendships, and unforgettable journeys"
          action={
