          ...
          {GENRES.map((g, i) => {
            ...
            return (
              <motion.button
                ...
                className="group relative aspect-[4/3] overflow-hidden rounded-xl border bg-[#0f172a] transition-all duration-300"
                style={{
              ...
              >
                ...
                <div className="absolute inset-0 bg-[rgba(124,58,237,0)] transition-all duration-300 group-hover:bg-[rgba(124,58,237,0.1)]" />
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-[#94a3b8] transition-colors group-hover:text-white">
                    {g.name}
                  </span>
                </div>

                {/* Bottom purple accent on hover */}
                <div className="absolute inset-x-0 bottom-0 h-[2px] scale-x-0 bg-gradient-to-r from-[#7c3aed] to-[#a855f7] transition-transform duration-300 group-hover:scale-x-100" />
              </motion.button>
            );
          })}
        </div>
